...
#Tools
gem 'descriptive_statistics', '~> 2.4.0', :require => 'descriptive_statistics/safe'  #dds methods to the Enumerable module to allow easy calculation of basic descriptive statistics
...
gem 'jquery-datatables-rails', '~> 3.3.0'                                            # jquery-datatables gem for rails
